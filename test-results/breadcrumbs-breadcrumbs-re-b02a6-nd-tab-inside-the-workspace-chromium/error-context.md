...
- Name: breadcrumbs.spec.ts >> breadcrumbs >> renders matter title and tab inside the workspace
- Location: e2e\breadcrumbs.spec.ts:22:5
...
Call log:
  - navigating to "http://localhost:5174/investigations/inv-001/interviews", waiting until "load"
