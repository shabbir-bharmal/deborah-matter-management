...
- Name: pagination.spec.ts >> investigations pagination >> shows a compact pager: first two pages, ellipsis, then the last page
- Location: e2e\pagination.spec.ts:79:5
