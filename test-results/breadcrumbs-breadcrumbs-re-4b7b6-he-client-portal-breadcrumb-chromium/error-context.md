...
- Name: breadcrumbs.spec.ts >> breadcrumbs >> renders client name in the client portal breadcrumb
- Location: e2e\breadcrumbs.spec.ts:30:5
...
Call log:
  - navigating to "http://localhost:5174/clients/northwind-logistics", waiting until "load"
