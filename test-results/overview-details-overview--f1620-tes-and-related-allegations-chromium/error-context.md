...
- Name: overview-details.spec.ts >> overview allegations and witnesses dialogs >> opens the witness detail dialog with notes and related allegations
- Location: e2e\overview-details.spec.ts:43:5
