...
- Name: overview-details.spec.ts >> overview allegations and witnesses dialogs >> chains between dialogs: allegation → witness via related witness chip
- Location: e2e\overview-details.spec.ts:27:5
